...
export default defineConfig({
  ...
  use: { launchOptions: { timeout: 15000 }, baseURL: 'http://127.0.0.1:4173', serviceWorkers: 'block', trace: 'retain-on-failure', screenshot: 'only-on-failure', viewport: { width: 1440, height: 1000 } },
